            ...
            <div class="container-fluid">
                                            ...
                                            <div class="modal fade" id="add_link" tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <form id="add-link-form" data-single="true"
                                                                    ...
                                                                    <div class="col-xl-6">
                                                                        ...
                                                                        <div class="col-xl-12">
                                                                            <label for="link-url"
                                                                                class="form-label">Link
                                                                                URL</label> 
                                                                                <input type="url" class="form-control" id="link-url" placeholder="Link URL: https://" required name="link_url"
                                                                                    pattern="https?://.*">
                                                                        </div>
                                                                        <br>
                                                                        <div class="col-xl-12">
                ...
                <div class="row">
                    <div class="col-xl-9">
                        <div class="card-body">
                            <div class="row">
                                <?php include "todo/links_list.php" ?>
